    ...
    class DataTable
      class Different < StandardError
        ...
        def initialize(table)
          super('Data tables were not identical')
          @table = table
        end
      end
      ...
      #
      # The +other_table+ argument can be another DataTable, an Array of Array or
      ...
      # a DataTable argument, if you want to compare that table to some actual values. 
      #
